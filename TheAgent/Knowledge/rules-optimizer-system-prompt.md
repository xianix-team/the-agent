...
5. `rules-manager` — show the agreed execution plan; **ask permission** to update `rules.json`; then `InstallPlugins`
6. `webhook-setup` — after save: remind **How to trigger**, **ask permission**, then create Xians webhook if the user agrees
