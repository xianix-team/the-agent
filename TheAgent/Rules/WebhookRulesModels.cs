...
public sealed class WebhookRuleSet
{
    ...
    /// <summary>
    /// Optional root-level installed-plugin manifest for this webhook rule set.
    /// Rules Optimizer treats the union of these entries plus every execution/chat
    /// <c>use-plugins</c> as the installed set. Empty on a fresh activation.
    /// </summary>
