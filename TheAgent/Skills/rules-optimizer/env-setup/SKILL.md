---
name: env-setup
description: Auto-check vault secrets with tools; never ask if secrets exist; then rules-manager.
---

# Environment variables

This skill teaches the **workflow**. `CheckTenantSecretExists` / `GetTenantState` perform checks.
