...
description: GetTenantState + live marketplace; user chooses Ready plugin; evidence before plugin-config.
---

# Marketplace discovery

This skill teaches the **workflow**. `ListAvailablePlugins` performs the fetch.

Follow **context → action → evidence**. Source: official `xianix-team/plugins-official`
marketplace.json via `ListAvailablePlugins`.
